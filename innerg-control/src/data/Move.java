 ...
 * Elle a en attribut un id et un nom qui caract�rise le mouvement.
 * Une methode permet de calculer l'ecart avec un autre mouvement
 * Une methode permet d'initialiser le mouvement � partir d'un fichier texte
...
public class Move {
	...
	//Initialise un mouvement � partir d'un fichier
	//!!!! Cette fonction contient le nombre de parametres (6) a changer si nouvelles donn�es (giro, gps etc...)
	...
	public void saveMove(String filepath)
	{
	    ...
	    try{
	      ...
	      if(true) System.out.println("Move : Fichier sauvegard� !");
	      out.close();
	    }
	    catch(Exception e){
	      e.printStackTrace();
